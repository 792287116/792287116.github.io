...
export const siteConfig: SiteConfig = {
	// 站点标题
	title: "Steven's Field Notes",

	// 站点副标题
	subtitle: "把思考写下来，让作品慢慢发光。",

	// 站点 URL
	site_url: "https://792287116.github.io",

	// 站点描述
	description:
		"一个偏技术与成长记录的博客，记录项目复盘、产品想法和个人随笔。",
	...
	navbar: {
		...
		logo: {
			type: "icon",
			value: "material-symbols:edit-square-outline-rounded",
			alt: "Steven's Field Notes",
		},
		// 导航栏标题
		title: "Steven's Field Notes",
		// 全宽导航栏，导航栏是否占满屏幕宽度
